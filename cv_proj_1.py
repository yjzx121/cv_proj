...
if __name__ == '__main__':
	...
	path = '/Users/aifun/Desktop/myworkfile/'
	image1 = cv2.imread(path + 'build_1.jpeg')
	image2 = cv2.imread(path + 'build_2.jpeg')

	stitch_match = FindKeyPointsAndMatching()
	...
	cv2.imwrite('build-output.jpeg',merge_image)
	print('\n========>Output saved!')
